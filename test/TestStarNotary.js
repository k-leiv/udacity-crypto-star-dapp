...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(await instance.name.call(), "Galactic Ethereum");
    assert.equal(await instance.symbol.call(), "GLE");
});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    await instance.createStar(starName, 10, {from: accounts[1]});
